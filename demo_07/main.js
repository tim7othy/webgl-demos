(function() {
  ...
  var getFragmentShaderSource = function() {
    return `
      ...
      void main() {
        ...
        float light = dot(normal, u_reversedLightDirection);
  ...
  var drawScene = function(gl, scale, angleInRadians, translation, cameraAngleRadians) {
    ...
    var worldMatrixInverse = m4.inverse(worldMatrix);
    var worldMatrixInverseTranspose = m4.transpose(worldMatrixInverse);

    // 设置矩阵
    gl.uniformMatrix4fv(worldUniformLocation, false, worldMatrixInverseTranspose);
